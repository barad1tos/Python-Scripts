...
- **Commit Messages:** All commit messages should be detailed and formatted in Markdown. The first line should be a concise summary (under 50 characters), followed by a blank line, and then a more detailed explanation of the changes, their motivation, and any related issues or context. This helps maintain a clear and informative commit history.
