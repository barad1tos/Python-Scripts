...
class Analytics:
    ...
    def log_event(
        ...
        # Also log to console and analytics log
        msg = (f"[Analytics] Function={function_name}, Event={event_type}, "
               f"Duration={duration:.4f}s, Success={success}")
        self.console_logger.info(msg)
        self.analytics_logger.info(msg)
    ...
    def generate_reports(self):
        ...
        try:
            ...
            self.analytics_logger.info("[Analytics] HTML report generated successfully.")
        except Exception as e:
